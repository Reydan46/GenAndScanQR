        ...
        implements SurfaceHolder.Callback, Camera.PreviewCallback
{
    ...
    private static int col_visibility;
     ...
     */
    private void setPreviewCameraId(int cameraId)
    {
    ...
    public interface OnQRCodeReadListener
    {
        ...
        void onQRCodeRead(String text, PointF[] points, boolean Visibility);
    }
...
//                Log.d(TAG, "ChecksumException", e);
            ...
            {
                if (col_visibility < 21)
                {
                    col_visibility = col_visibility + 1;
                }
        ...
        protected void onPostExecute(Result result)
        {
            ...
            if (view != null && view.mOnQRCodeReadListener != null)
            {
                if (result != null)
                {
                    ...
                    col_visibility = 1;
                    Log.d(TAG, String.valueOf(col_visibility));
                    if (true)
                    {
                        view.mOnQRCodeReadListener.onQRCodeRead(result.getText(), transformedPoints, true);
                        show = true;
                    }
                ...
                {
                    if (col_visibility > 20)
                    {
                        view.mOnQRCodeReadListener.onQRCodeRead(null, null, false);
                        show = false;
                    }
                }
            }
