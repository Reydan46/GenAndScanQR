...
class QRToViewPointTransformer
{
    ...
    PointF[] transform(ResultPoint[] qrPoints, boolean isMirrorPreview,
    ...
    private PointF transform(ResultPoint qrPoint, boolean isMirrorPreview, Orientation orientation,
                             Point viewSize, Point cameraPreviewSize)
    {
        ...
        else if (orientation == Orientation.LANDSCAPE)
        {
            ...
            transformedPoint = new PointF(
                    viewSize.x - qrPoint.getX() * scaleX,
